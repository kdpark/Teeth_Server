...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'meeting_user', 'user_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=40, unique=True),
                      keep_default=False)
    ...
    models = {
        u'meeting.user': {
            ...
            'fb_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
